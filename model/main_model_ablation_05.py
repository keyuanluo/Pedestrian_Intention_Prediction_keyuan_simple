...
import numpy as np
from model.model_blocks_ablation_05 import EmbedPosEnc, AttentionBlocks, Time_att, TimeTransformer
from model.FFN import FFN
from model.BottleNecks_ablation_05 import Bottlenecks
...
class Model(nn.Module):
    ...
    def forward(self, bbox, vel):
        ...
        bnk = self.relu(self.time_transformer(self.bottlenecks(bbox, vel))) # Bottlenecks
