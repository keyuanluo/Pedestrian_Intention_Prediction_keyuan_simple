...
def check_time_diff_s_over_05_summary(excel_path):
    ...
    output_file = os.path.join(output_dir, "time_diff_over_05_summary_gyro.xlsx")

    df_summary.to_excel(output_file, index=False)
    print(f"[信息] 已将汇总统计保存到: {output_file}")

if __name__ == "__main__":
    excel_path = r"/media/robert/4TB-SSD/watchped_dataset/combined_video_image_and_gyro_matched_03.xlsx"
